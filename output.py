...
def gen_output(fr,data,init_val):
    ...
    for ind,f in enumerate(frame):
        ...
        for cr in ((0,0),(0,1),(0,2),(1,0),(1,1),(1,2),(2,0),(2,1),(2,2)):
            if (offset[0]+cr[0],offset[1]+cr[1]) in init_val:
                txt = tk.Label(master=f,width=3,height=1,text=data[(offset[0]+cr[0],offset[1]+cr[1])],font='Helvetica 10 bold italic',bg='AntiqueWhite2')
            else:
